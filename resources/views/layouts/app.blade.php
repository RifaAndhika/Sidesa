...
<head>
   ...
   <title>SiDesa - @yield('title', 'Dashboard')</title>
  ...
  <script>
    $(document).ready(function () {
        $('#table').DataTable({
            ...
            info: false,         // Nonaktifkan "Showing x to y of z entries"
            ordering: false,     // Optional: Nonaktifkan sorting jika tidak dibutuhkan
